    ...
    const load = async (nextPage = page) => {
        ...
        try {
            const res = await axiosClient.get(
                `/manager/applications/list?page=${encodeURIComponent(String(nextPage))}&limit=${encodeURIComponent(
                    String(limit)
                )}`
            );
                            ...
                            filtered.map((r) => (
                                <TableRow key={r._id}>
                                    ...
                                    <TableCell className="text-right text-xs">
                                        <AcceptApplication application_id={r._id} applicationLoadList={load} />
                                    </TableCell>
                                </TableRow>
                            ))
                        )}
